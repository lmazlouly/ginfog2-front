...
import { MainNav } from "@/components/frontend/layout/main-nav";
// import { ThemeToggle } from "@/components/frontend/layout/theme-toggle";
...
export function SiteHeader() {
  ...
  return (
    <header className="top-0 z-50 backdrop-blur bg-gradient-to-r from-green-50 to-teal-50">
